...
const Event = () => {
  ...
  const handleCheckMap = () => {
    window.open('https://goo.gl/maps/tsAT45h26t7svfMZ6', '_blank');
  };
    ...
    <>
      ...
      <div className="w-3/4 md:w-1/2">
        <p className="font-body text-gray-700 text-xs md:text-base">
          ...
          doa restu pada acara tasyakuran pernikahan putra-putri kami yang akan
            ...
            <div className="relative z-10 text-left">
              ...
              <div className="mt-2">
                <p className="font-body font-bold text-sm text-theme-orange">
                  Sabtu, 21 Mei 2022 (Telah Dilaksanakan)
                </p>
          ...
          <div className="relative overflow-hidden w-full p-4 rounded-lg bg-flower-pattern bg-80% shadow-md">
            <div className="relative z-10 text-left">
              ...
              <div className="mt-4">
                ...
                <p className="font-body font-bold text-sm text-theme-orange">
                  Grand Regency Blok C1 No.77
                  <br /> Kel. Padurenan, Kec. Mustika Jaya, Kota Bekasi
                </p>
              </div>
              <div
