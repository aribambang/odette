      ...
      <main className="z-10 flex flex-col items-center justify-center w-full flex-1 text-center px-10 md:px-0">
        ...
        <div className="text-center py-4 px-8 leading-relaxed md:max-w-screen-md md:mx-auto">
          <p>
            ...
            bersama, bersuka cita. Tapi kita tahu, dunia sedang dilanda bencana
            yang membuat satu dan lainnya berjarak dengan penutup muka. Semua
            yang sudah kami siapkan juga harus dibatasi dengan protokol yang
            ada.
          </p>
          <p className="pt-4">
          ...
          <p className="pt-4">
            Dari kami, semoga semua dapat memaklumi dan kita bisa tidak berjarak
            lagi. Amin.
          </p>
